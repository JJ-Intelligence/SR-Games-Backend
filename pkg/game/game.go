...
type GameService struct {
	...
	HandleRequest func(chan GameRequest, interface{}, string, string, interface{}) (interface{}, error)
}
...
func NewGame(name string, p *plugin.Plugin) GameService {
	...
	return GameService{
		...
		HandleRequest: handleRequest.(func(chan GameRequest, interface{}, string, string, interface{}) (interface{}, error)),
	}
}
